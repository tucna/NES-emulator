  ...
  m_clockCount(0)
{
  ...
  m_lookup =
  {
    ...
    { 0xE0, "CPX", &Cpu::CPX, &Cpu::IMM, 2 },{ 0xE1, "SBC", &Cpu::SBC, &Cpu::IZX, 6 },{ 0xE2, "NOP", &Cpu::NOP, &Cpu::IMM, 2 },{ 0xE3, "???", &Cpu::XXX, &Cpu::IMP, 8 },{ 0xE4, "CPX", &Cpu::CPX, &Cpu::ZP0, 3 },{ 0xE5, "SBC", &Cpu::SBC, &Cpu::ZP0, 3 },{ 0xE6, "INC", &Cpu::INC, &Cpu::ZP0, 5 },{ 0xE7, "???", &Cpu::XXX, &Cpu::IMP, 5 },{ 0xE8, "INX", &Cpu::INX, &Cpu::IMP, 2 },{ 0xE9, "SBC", &Cpu::SBC, &Cpu::IMM, 2 },{ 0xEA, "NOP", &Cpu::NOP, &Cpu::IMP, 2 },{ 0xEB, "SBC", &Cpu::SBC, &Cpu::IMM, 2 },{ 0xEC, "CPX", &Cpu::CPX, &Cpu::ABS, 4 },{ 0xED, "SBC", &Cpu::SBC, &Cpu::ABS, 4 },{ 0xEE, "INC", &Cpu::INC, &Cpu::ABS, 6 },{ 0xEF, "???", &Cpu::XXX, &Cpu::IMP, 6 },
